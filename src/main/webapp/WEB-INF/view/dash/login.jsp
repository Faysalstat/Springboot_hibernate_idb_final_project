<%-- 
    Document   : login
    Created on : Mar 28, 2020, 11:38:53 PM
    Author     : Faysal
--%>
...
<html>
    ...
    <body>
        ...
        <div id="login-page">
            <div class="container">
                <form id="adminlogin" method="POST" action="loginchk" class="form-login" modelAttribute="user" >
                    ...
                    <div class="login-wrap">
                        ...
                        <button class="btn btn-theme btn-block" form="adminlogin" href="index.html" type="submit"><i class="fa fa-lock"></i> SIGN IN</button>
                        <hr>
        ...
        <script type="text/javascript" src="/dash/lib/jquery.backstretch.min.js"></script>
        <script>
            $.backstretch("/dash/img/login-bg.jpg", {
                speed: 500
            });
        </script>
    </body>
