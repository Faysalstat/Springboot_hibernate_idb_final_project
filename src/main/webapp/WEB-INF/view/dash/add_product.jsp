                ...
                function uploadImage() {
                    ...
                    request.onreadystatechange = function () {
                        if (this.readyState === 4 && this.status === 200) {
                            ...
                            document.getElementById("imagename").value = img.iname;
                        }
                    };
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="form-panel">
                                <h2 class="mb">Update Product</h2>
                                <form action="addproducttodatabase" method="POST" id="products" modelAttribute="product">
                                                ...
                                                <div class="form-group last">
                                                    ...
                                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                                        <div class="fileupload-new thumbnail" style="width: 250px; height: 150px;">
                                                            <img id="img" src="/dash/img/icon.png" width="250" height="150" alt="image" />
                                                        </div>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" form="products" value="Submit" class="btn btn-primary btn-lg btn-block">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
